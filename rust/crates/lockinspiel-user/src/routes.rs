...
//     description = "Deletes the account of the currently userenticated user.",
//     responses(
//         (status = OK, description = "Ok"),
//         (status = "4XX", description = "It's your fault",
//             content(
...
//     tag = "Session",
//     summary = "Logout",
//     description = "Logs out of the currently userenticated user (invalidates the current session)",
//     responses(
//         (status = OK, description = "Ok",
//             content(
//                 (LoginToken, example = LoginToken::placeholder)
